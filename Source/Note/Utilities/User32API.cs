...
public static class User32API
{
    ...
    internal static extern IntPtr SetWindowLongPtr32(IntPtr hWnd, int Attribute, IntPtr Value);
    ...
    internal static extern long GetWindowLong32(IntPtr hWnd, int Attribute);
